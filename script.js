...
fur.addEventListener("click", () => {
    display.innerHTML = "<img src = 'images/furina.jpg'>Name: " + data.furina.name + "<br>Element: " 
...
cha.addEventListener("click", () => {
    display.innerHTML = "<img src = 'images/chasca.png'>Name: " + data.chasca.name + "<br>Element: " 
...
zib.addEventListener("click", () => {
    display.innerHTML = "<img src = 'images/zibai.jpg'> Name: " + data.zibai.name + "<br>Element: "
